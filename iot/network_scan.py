...
MAC_VENDORS = {
    ...
    "50:11:F2": "Ecovacs (Aspiradora Robot)",
    "D8:29:10": "August (Cerradura Inteligente)",
    "58:9C:FC": "Nuki (Cerradura Inteligente)",
    "E8:7D:66": "Samsung (Heladera Inteligente)",
    "3C:BD:3E": "LG ThinQ (Lavarropas)",
    "64:52:99": "LG Smart (Lavarropas)",
    "B4:99:4C": "LG Electronics (Electrodoméstico)",
    "60:6B:BD": "Samsung Smart (Lavarropas)",
    "48:60:5F": "Samsung (Electrodoméstico)",
    "CC:B1:1A": "Samsung (SmartThings)",
    "D0:03:DF": "Samsung Electronics",
    "00:25:8D": "Haier (Electrodoméstico)",
    "2C:37:C5": "Haier (Casa Inteligente)",
    "C0:E4:34": "Whirlpool (Electrodoméstico)",
    "00:24:E4": "Withings (Balanza/Salud)",
    "00:10:C6": "Fitbit (Reloj/Salud)",
    "44:FB:42": "Tesla (Cargador/Auto)",
    "D0:CF:5E": "Wallbox (Cargador EV)",
    "34:94:54": "Shelly (Interruptor/Relay)",
    "40:F5:20": "Shelly (Smart Cloud)",
    "48:3D:33": "Shelly (Dispositivo)",
    
    # --- IoT Genérico / Chips WiFi (Luces y Enchufes) ---
    "64:BB:1E": "Sagemcom (Deco/Router)",
    "00:17:88": "Philips Hue (Iluminación)",
    "EC:B5:FA": "Yeelight/Xiaomi (Luz)",
    "50:EC:50": "Xiaomi (Dispositivo)",
    "A0:46:5A": "Motorola (Celular)",
    "24:6F:28": "Espressif (Tuya/SmartLife)",
    "84:F3:EB": "Espressif (NodeMCU/DIY)",
    "DC:4F:22": "Espressif (Chip WiFi)",
    "8C:98:06": "SEI Robotics (Deco/Box)",
    "2C:D8:AE": "SEI Robotics (Android TV)",
    "D4:CF:F9": "SEI Robotics (Box/Intercom)",
    "70:89:76": "Tuya (Enchufe/Luz)",
    "1C:90:FF": "Tuya (Dispositivo)",
    "00:0B:44": "ITEAD / Sonoff (Interruptor)",
    "34:29:8F": "Meross (Enchufe Smart)",
    "B8:27:EB": "Raspberry Pi (Servidor)",
    "DC:A6:32": "Raspberry Pi 4",
    
    # --- Celulares / Tablets / Relojes ---
    "A4:D1:8C": "Apple (iPhone/iPad/Watch)",
    "DC:2B:2A": "Apple (Watch/Mac)",
    "24:F5:AA": "Samsung Galaxy (Celu/Tab)",
    "00:16:32": "Samsung Mobile",
    "60:6B:BD": "Samsung (Lavarropas/Smart)",
    "48:60:5F": "Samsung (Electrodoméstico)",
    "E4:07:4D": "Samsung (Lavarropas)",
