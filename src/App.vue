...
const version = "Fina Ergen v 3.5.8-3 (04/03/2026 19:30)";
const buildDate = "Mié 04 Mar 2026 19:30";
                            ...
                            <div v-if="!activeSettingsDomain"
                                ...
                                <div class="grid grid-cols-2 lg:grid-cols-4 gap-8 w-full max-w-5xl">
                                    ...
                                    <button
                                        ...
                                        <span
                                            class="text-xs font-black text-slate-200 uppercase tracking-widest z-10">{{
                                            t('ui_domain',
                                            'Dominio') }}<br><span class="text-indigo-400 text-lg">{{ t('ui_dom_intel',
                                                'Inteligencia')
                                                }}</span></span>
                                    </button>
                                    ...
                                    <button @click="activeSettingsDomain = 'visual'; activeSettingsTab = 'tv'"
                                        ...
                                        <span
                                            class="text-xs font-black text-slate-200 uppercase tracking-widest z-10">{{
                                            t('ui_domain',
                                            'Dominio') }}<br><span class="text-purple-400 text-lg">{{ t('ui_dom_visual',
                                                'Visual')
                                                }}</span></span>
                                    </button>
                                    ...
                                    <button @click="activeSettingsDomain = 'habitat'; activeSettingsTab = 'aire'"
                                        ...
                                        <span
                                            class="text-xs font-black text-slate-200 uppercase tracking-widest z-10">{{
                                            t('ui_domain',
                                            'Dominio') }}<br><span class="text-emerald-400 text-lg">{{
                                                t('ui_dom_habitat', 'Habitat')
                                                }}</span></span>
                                    </button>
                                    ...
                                    <button @click="activeSettingsDomain = 'seguridad'; activeSettingsTab = 'biometria'"
                                        ...
                                        <span
                                            class="text-xs font-black text-slate-200 uppercase tracking-widest z-10">{{
                                            t('ui_domain',
                                            'Dominio') }}<br><span class="text-red-400 text-lg">{{ t('ui_dom_security',
                                                'Seguridad')
                                                }}</span></span>
                                    </button>
                                </div>
